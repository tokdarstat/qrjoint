...
extern void DEV(double *, double *, double *, int *, double *, int *, double *, int *, double *,double *, double *, double *, double *, double *);
extern void DEV_noX(double *, double *, int *, double *, double *, int *, double *, double *, double *, double *, double *, double *);
extern void PRED_noX(double *, double *, double *, int *, double *, double *, double *);
...
static const R_CMethodDef CEntries[] = {
  ...
  {"INIT_noX", (DL_FUNC) &INIT_noX, 10},
    ...
    {"DEV",  (DL_FUNC) &DEV,  14},
    {"DEV_noX", (DL_FUNC) &DEV_noX,  12},
    {"PRED_noX", (DL_FUNC) &PRED_noX,  7},
    {NULL, NULL, 0}
};
